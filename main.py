...
if __name__ == '__main__':
    ...
    parser.add_argument('--trans_type', type=str, default='post_cond', help='choose in {pre_cond, post_cond, jaccard, cosine}')
    ...
    # 嵌入优化相关参数
    parser.add_argument('--emb_init_type', type=str, default='xavier_normal',
                      choices=['xavier_normal', 'xavier_uniform', 'kaiming_normal', 'kaiming_uniform', 'normal'])
    parser.add_argument('--emb_reg_type', type=str, default='l2',
                      choices=['l2', 'l1', 'l2+l1', 'none'])
    parser.add_argument('--contrast_weight', type=float, default=0.15, help='对比损失权重')
    parser.add_argument('--contrast_temp', type=float, default=0.165, help='对比损失温度参数')
